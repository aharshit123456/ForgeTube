...
# rodents_clip = rodents_clip.with_section_cutout(start_time=4, end_time=10)
...
# CLIPS TIMING #
################
# We have all the clips we need, but if we was to turn all those clips into a single one with composition (we will see that during next step)
